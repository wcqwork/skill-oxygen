<div data-gjs-type="phoenix-container" data-strong="1">
	...
	[/#if]
  <div class="backstage-blocksEditor-wrap block35874" data-block-uuid="articlelist"  data-gjs-type="developer-node-component" data-block-list-setting="dataSelect,loadMethod,pageNumber,dataOrderBy" 
  ...
  data-default-setting={"pageSize":3,"page":1,"dataType":"0","dataIds":[],"dataGroupId":[],"orderBy":"0","loadMethod":"0","refreshMethod":"0","jumpMethod":"0","expandIds":{"showField":{"label":"显示字段","key":"showField","draggable":false,"data":[{"fieldName":"文章标题","fieldId":"articleTitle","fieldType":"0","value":"1","checked":false},{"fieldName":"文章简介","fieldId":"articleSummary","fieldType":"0","value":"2","checked":false},{"fieldName":"日期","fieldId":"publishTime","fieldType":"0","value":"3","checked":false},{"fieldName":"文章分类","fieldId":"cateName","fieldType":"0","value":"4","checked":false}]}},"expandSort":["showField"],"layoutStyle":"0","showDate":"1","relatedTypes":"0","translationEntry":[]}>
    ...
    [#if __current_site_lanCode__?? && specialLanCode?seq_contains(__current_site_lanCode__)]
        <!-- 此处写小语种特殊的css代码。比如下面图1中让两个元素到右边 -->
        <style data-collect='1'>
            div .block35874 .textBox{
                direction: rtl;
                text-align: right;
            }
        
            div .block35874 .icona>i{
                right:unset;
                left: 20px;
                transform: translateY(-50%) rotate(180deg);
            }
            div .block35874 .line02{
                right:unset;
                left: 65px;
            }
            div .block35874 .line{
            ...
            @media screen and (min-width: 739px){
                div .block35874 .articleTile:nth-of-type(1) .textBox{
            ...
            [@api method="post" url="/phoenix2/composite/graphql" page="${pageNum!1}" limit="${pageSize!'10'}"
                ...
                <div class="block-article-container-replace">
                    ...
                    <div class="ArticlePicList_Item articleTile">
                        <div class="imgBox">
                            <a class="articleMask" href="${article.articleUrl!''}" title="${article.articleTitle!?html}"></a>
                            <picture>
                                <source media="(min-width: 450px)" srcset="${article.photoUrlNormal!''}" />
                                <source media="(max-width: 449px)" srcset="${article.photoUrlNormal!''}" />
                                <img class="headlines-content-img ArticlePicList_ItemImg articleImg" src="${article.photoUrlNormal!''}" alt="${article.photoSeoList[0].photoAlt!}" title="${article.photoSeoList[0].photoTitle!}">
                            </picture>
                        </div>
                        <div class="ArticlePicList_ItemContent textBox">
                            <a class="ArticlePicList_ItemContentInnerA textMask" href="${article.articleUrl!''}"> </a>
                            <div class="ArticlePicList_ItemContentInner">
                                <div class="ArticlePicList_ItemContentInnerBox">
                                    <div class="line"></div> 
                                    <a class="ArticlePicList_ItemContentInnerA icona" href="${url}">
                                        <i class="font-icon icon iconfont_phoenix icon-icon-xiangyou"> </i>
                                    </a> 
                                    ...
                                    <a class="ArticlePicList_ItemContentInnerA button paragraph2" href="${article.articleUrl!''}" title="${article.articleTitle!?html}"><span>[@s.m "phoenix_read_more" /]</span></a>
                ...
                <script>
                    $(function(){
                        window._block_namespaces_['block35874'].init({'relationId':'${relationId}','relationType':'${relationType}','pageId':'${pageId}','nodeId':'articlelist_${nodeId!""}', 'appId': '${appId!}', 'appIsDev': '${appIsDev!"0"}','appVersion':'${appVersion}'});
                    });
                </script>
