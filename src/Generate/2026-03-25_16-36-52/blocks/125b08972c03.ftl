...
<div class="swiper-slide blog-card">
          ...
          <h5><a href="${article.articleUrl!''}" title="${article.articleTitle!?html}">Top 10 Tips for Your Kitchen Interior Design</a></h5>
...
[/@api]
        ...
        <script>
            $(function () {
                window._block_namespaces_['block_125b08972c03'].init({ 'relationId': '${relationId}', 'relationType': '${relationType}', 'pageId': '${pageId}', 'pageNodeId': '${pageNodeId!""}', 'appId': '${appId!}', 'appIsDev': '${appIsDev!"0"}', 'appVersion': '${appVersion}' });
            });
        </script>
    </div>
</div>