<div class="block_07b6f345ecd4" data-gjs-type="phoenix-container" data-strong="1">
...
[/@api]
        ...
        <script>
            $(function () {
                window._block_namespaces_['block_07b6f345ecd4'].init({ 'relationId': '${relationId}', 'relationType': '${relationType}', 'pageId': '${pageId}', 'pageNodeId': '${pageNodeId!""}', 'appId': '${appId!}', 'appIsDev': '${appIsDev!"0"}', 'appVersion': '${appVersion}' });
            });
        </script>
    </div>
</div>