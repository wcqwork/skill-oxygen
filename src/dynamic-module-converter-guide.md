...
window.__DYNAMIC_MODULES__ = {
  templatePaths: {
    "5421eed41b11": "dynamic_block/5421eed41b11.ftl"
  },
  modules: [{
    uuid: "5421eed41b11",
    blockType: "phoenix_blocks_prodlist",
    appId: "eRKAfpUNFbOE",
    templatePath: "dynamic_block/5421eed41b11.ftl",
  }],
...
```json
{
  ...
  "inputFile": "src/page.html",
  "outputFile": "src/dynamic_page.html",
  "totalSections": 1,
  "dynamicSections": 1,
  "staticSections": 0,
  "detections": [{
...
| `verify-export-path.mjs` | `npm run verify:export` | ~31 项 | dynamic_block/ 目录、FTL 文件映射、VM 沙箱执行、inject() 模拟 |
...
| `--output` | ❌ | `dynamic_<原文件名>.html` | 输出文件路径 |
| `--auto` | ❌ | 关闭 | 自动模式，跳过用户确认 |
